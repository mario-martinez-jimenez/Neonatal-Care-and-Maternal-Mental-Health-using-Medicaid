...
\author{
Mario Mart\'{\i}nez-Jim\'enez\thanks{Imperial Business School, Department of Economics \& Public Policy. Stanford University School of Medicine (Department of Health Policy).}
\and
Helen Kissel\thanks{Stanford University}
}
...
\section{Background: Levels of Neonatal Care in the U.S.}
...
\begin{figure}[htbp!]
\centering
\caption{NICU locations weighted by local concentration}
\includegraphics[width=\textwidth]{Figures/Background/nicu_locations_weighted.png}
\label{fig:nicu_locations_weighted}
\end{figure}
...
\appendix
\section{Appendix: U.S. Birth Trends, 1995--2024}

\begin{figure}[htbp!]
\centering
\caption{U.S. preterm births ($<38$ weeks), 1995--2024}
\includegraphics[width=\textwidth]{Figures/Background/trend_preterm_lt38_1995_2024.png}
\label{fig:appendix_preterm_lt38_1995_2024}
\end{figure}

\begin{figure}[htbp!]
\centering
\caption{U.S. very low birthweight births ($<1{,}500$ grams), 1995--2024}
\includegraphics[width=\textwidth]{Figures/Background/trend_extreme_low_bw_lt1500g_1995_2024.png}
\label{fig:appendix_vlbw_lt1500_1995_2024}
\end{figure}

\begin{figure}[htbp!]
\centering
\caption{U.S. low birthweight births ($<2{,}500$ grams), 1995--2024}
\includegraphics[width=\textwidth]{Figures/Background/trend_low_bw_lt2500g_1995_2024.png}
\label{fig:appendix_lbw_lt2500_1995_2024}
\end{figure}
