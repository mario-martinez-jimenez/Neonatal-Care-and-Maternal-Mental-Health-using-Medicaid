...
Figure~\ref{fig:nicu_beds_aggregate} visualizes aggregate Level III+IV NICU bed capacity. Capacity is geographically concentrated in larger metropolitan and referral regions, with substantial heterogeneity across states and within states at the county level.
...
\begin{minipage}{0.49\textwidth}
  \centering
  \includegraphics[width=\linewidth]{Figures/Background/nicu_state_level_III_IV_beds.png}
\end{minipage}\hfill
\begin{minipage}{0.49\textwidth}
  \centering
  \includegraphics[width=\linewidth]{Figures/Background/nicu_county_level_III_IV_beds.png}
\end{minipage}
