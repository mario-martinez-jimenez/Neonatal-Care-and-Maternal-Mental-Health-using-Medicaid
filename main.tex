...
Figure~\ref{fig:nicu_beds_aggregate} visualizes aggregate Level III+IV NICU bed capacity. Figures~\ref{fig:nicu_levels_state} and \ref{fig:nicu_levels_county} show facility-count heterogeneity by NICU level (II, III, and IV). Higher-acuity capacity is concentrated in large metropolitan/referral systems, with substantial cross-county variation within states.
...
\begin{figure}[htbp!]
\centering
\caption{NICU facility counts by state (Levels II, III, and IV)}
\includegraphics[width=0.95\textwidth]{Figures/Background/nicu_state_level_II_count.png}
\vspace{0.5em}
\includegraphics[width=0.95\textwidth]{Figures/Background/nicu_state_level_III_count.png}
\vspace{0.5em}
\includegraphics[width=0.95\textwidth]{Figures/Background/nicu_state_level_IV_count.png}
\label{fig:nicu_levels_state}
\end{figure}

\begin{figure}[htbp!]
\centering
\caption{NICU facility counts by county (Levels II, III, and IV)}
\includegraphics[width=0.95\textwidth]{Figures/Background/nicu_county_level_II_count.png}
\vspace{0.5em}
\includegraphics[width=0.95\textwidth]{Figures/Background/nicu_county_level_III_count.png}
\vspace{0.5em}
\includegraphics[width=0.95\textwidth]{Figures/Background/nicu_county_level_IV_count.png}
