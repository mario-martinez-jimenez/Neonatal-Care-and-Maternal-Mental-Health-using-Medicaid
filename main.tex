...
We describe (i) the distribution of Level III/IV NICU capacity across counties, (ii) travel distances for vulnerable versus non-vulnerable births, and (iii) postpartum mental health utilization patterns by access strata.

Figure~\ref{fig:nicu_locations} first shows NICU locations nationally. Figure~\ref{fig:nicu_levels_state} and Figure~\ref{fig:nicu_levels_county} then show facility-count heterogeneity for Level II versus combined Level III+IV. Figure~\ref{fig:nicu_beds_aggregate} reports aggregate Level III+IV bed capacity by state and county. Higher-acuity capacity is concentrated in large metropolitan/referral systems, with substantial cross-county variation within states.

\begin{figure}[htbp!]
\centering
\caption{NICU locations in the United States}
\includegraphics[width=0.95\textwidth]{Figures/Background/nicu_locations.png}
\label{fig:nicu_locations}
\end{figure}

\begin{figure}[htbp!]
\centering
\caption{Aggregate NICU bed capacity (Level III + Level IV)}
\includegraphics[width=0.95\textwidth]{Figures/Background/nicu_state_level_III_IV_beds.png}
\vspace{0.5em}
\includegraphics[width=0.95\textwidth]{Figures/Background/nicu_county_level_III_IV_beds.png}
\label{fig:nicu_beds_aggregate}
\end{figure}

\begin{figure}[htbp!]
\centering
\caption{NICU facility counts by state (Level II and Level III + IV)}
\includegraphics[width=0.95\textwidth]{Figures/Background/nicu_state_level_II_count.png}
\vspace{0.5em}
\includegraphics[width=0.95\textwidth]{Figures/Background/nicu_state_level_III_IV_count.png}
\label{fig:nicu_levels_state}
\end{figure}

\begin{figure}[htbp!]
\centering
\caption{NICU facility counts by county (Level II and Level III + IV)}
\includegraphics[width=0.95\textwidth]{Figures/Background/nicu_county_level_II_count.png}
\vspace{0.5em}
\includegraphics[width=0.95\textwidth]{Figures/Background/nicu_county_level_III_IV_count.png}
\label{fig:nicu_levels_county}
\end{figure}
